...
class ConfigService:
    ...
    def _test_deepseek_api(self, api_key: str, display_name: str, model_name: str = None, api_base: str = None) -> dict:
        ...
        try:
            ...
            # with low max_tokens all budget is consumed by reasoning, leaving empty content
            is_thinking_model = model_name and any(tag in model_name for tag in ["v4", "reasoner"])
            data = {
                "model": model_name,
                "messages": [
